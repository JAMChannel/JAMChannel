...
|2021年7月〜 |フリーランス(エンジニアスクール)   |業務委託(準委任契約), エンジニアメンター|
|2022年4月〜 2022年6月|フリーランス(ミンカブインフォノイド株式会社 )      |業務委託(準委任契約), バックエンドエンジニア|
|2022年7月〜 2023年2月|フリーランス(不動産購入サイトのAPI開発, 番組管理サイトの保守運用)|業務委託(準委任契約), バックエンドエンジニア|
|2023年3月〜 |フリーランス(在庫管理サービス)|業務委託(準委任契約), バックエンドエンジニア|
...
|DB     　　　　　| MySQL,DynamoDB | 
|インフラ環境    　| AWS / Docker | 
| 業務　　　　　　| / 在庫管理サービスの開発 / 追加機能の実装 / Rspecによるテスト / デプロイ| 

### プロジェクトの概要
___
【プロジェクト詳細】
- 在庫管理サービスの開発（web担当）の実装、テスト、デプロイ

【担当フェーズ】
- 追加機能の開発、Rspecを用いた単体テストの実装
...
- 在庫一覧印刷用ページ
- 在庫一覧検索機能の修正
- 選択した入出庫データだけ、ダウンロードできる機能
- インポートデータの修正

#### その他
- プロジェクト管理ツールjiraにてタスク管理を実施
...
|DB     　　　　　| MySQL | 
|インフラ環境    　| AWS / Docker | 
| 業務　　　　　　| / 家族信託サービスの開発 / 追加機能の実装 / Rspecによるテスト / デプロイ| 

### プロジェクトの概要
___
【プロジェクト詳細】
- 家族信託サービスの開発（web担当）の実装、テスト、デプロイ
...
|フレームワーク    | Ruby on Rails | 
|DB     　　　　　| MySQL | 
|インフラ環境    　| Amazon ECS   / Docker | 
| 業務　　　　　　| / RailsでWeb APIの設計 実装 / 追加機能の実装 / Rspecによるテスト / デプロイ| 

### プロジェクトの概要
___
【プロジェクト詳細】
- 不動産物件販売サイトのRailsをAPI設計からリリースまで担当
...
- マイページ(CRUD)
- 自動メール送信機能(GmailAPI)
- dockerによる環境構築（rails 6.1）

#### その他
- プロジェクト管理ツールBacklogにてタスク管理を実施
- swaggerにてAPI設計を実施
...
|フレームワーク       　　　　　| Ruby on Rails | 
|DB     　　　　　| MySQL | 
|インフラ環境    　| AWS Teraform  / Docker | 
| 業務　　　　　　| 運用保守 ・追加機能の実装 | 

## プロジェクトの概要
___
【プロジェクト詳細】
- 大手放送局の動画配信管理サイトの運用保守、APIやviewなどの追加機能を担当

【担当フェーズ】
追加機能の開発、Rspecを用いた単体テストの実装、運用保守
